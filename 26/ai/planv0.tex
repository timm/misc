...
Evidence tags: \Ecite\ = published/external source \quad \Epeer\ = peer-catalog evidence (Appendix~A)\\
\Epos\ = our position --- argument, weaker support, use with care.\par}
\vspace{0.4em}
\section*{Executive summary}
We cannot win a vote on ``CS owns AI.'' We can win ``CS teaches everyone's AI rigor, cheaply, starting this semester'' --- and the Provost has already endorsed every ingredient in print.
...
\addcontentsline{toc}{section}{Appendix A --- The Repertory Grids}
