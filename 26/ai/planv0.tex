...
Meanwhile every department on NC State's BOG-approved peer list is moving: Purdue ships a BS in AI; Arizona ships an AI BS and minor; Duke puts required AI into its CS core in Fall 2026; Maryland's AI bachelor's degrees arrive 2026--27; Virginia Tech's all-majors AI minor opened this month.\Epeer\ Our own BS-in-AI is on hold, reconfigured toward a joint ECE/ISE offering, and campus AI policy is set by many people, some of which do not have advanced degrees in CS.\Epos
