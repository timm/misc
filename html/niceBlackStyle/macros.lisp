...
Why is such flexability important? 

Well, it the [words of Paul Graham](https://sep.turbifycdn.com/ty/cdn/paulgraham/acl1.txt?t=1688221954&):
...
have even finished writing out the specifications.
...
(defmacro aif (test this &optional that)
   "the anaporic if lets code reference some prior conce (from the cnditional test)"
