...
----------------------------------------------------------------------------------------------------
local oid=0
function new(kl,...) oid=oid+1; local x={_s=kl, _id=oid}; kl.new(x,...); return x end 
function add(i,...)  return i._is.add(i,...) end
----------------------------------------------------------------------------------------------------
local NUM={}
function NUM:new() self.mu,self.m2,self.sd=0,0,0 
----------------------------------------------------------------------------------------------------
-- ## Strings to things
