...
- [Sym](#sym)
- [Breakout (Language): metatables](#breakout-language-metatables)
- [Num](#num)
- [Breakout (AI): Mean and standard deviation](#breakout-ai-mean-and-standard-deviation)
- [Breakout (AI): Welford's algorithm](#breakout-ai-welfords-algorithm)
- [Col](#col)
- [adds](#adds)
- [Breakout (Language): Iterators](#breakout-language-iterators)
- [Breakout (Language): Method calls](#breakout-language-method-calls)
- [Data](#data)
- [Cols](#cols)
- [clone](#clone)
- [DATA.add](#dataadd)
- [Lecture 1 exercises](#lecture-1-exercises)
- [SYM.like](#symlike)
- [Breakout (AI): Probability](#breakout-ai-probability)
- [Breakout (AI): The m-estimate](#breakout-ai-the-m-estimate)
- [NUM.like](#numlike)
- [Breakout (AI): Gaussian density](#breakout-ai-gaussian-density)
- [DATA.likes](#datalikes)
- [Breakout (AI): Log-probabilities](#breakout-ai-log-probabilities)
- [Breakout (AI): The naive Bayes assumption](#breakout-ai-the-naive-bayes-assumption)
- [nb](#nb)
- [eg](#eg)
- [Main](#main)
- [Lecture 2 exercises](#lecture-2-exercises)
- [isa](#isa)
- [the](#the)
- [lib](#lib)
- [Tables as both arrays and hashes](#tables-as-both-arrays-and-hashes)
- [`nil` is missing-or-false](#nil-is-missing-or-false)
...
## Appendix Z. Used-in index

Auto-generated. For each defined name, lists every later
section that mentions it.

- `Sym` — used in: Col, Cols, clone, Lecture 1 exercises, SYM.like, eg
- `Num` — used in: Col, adds, Cols, clone, Lecture 1 exercises, NUM.like
- `Col` — used in: Cols, DATA.add, Lecture 1 exercises, eg
- `adds` — used in: Data, clone, DATA.add, Lecture 1 exercises, SYM.like, NUM.like, DATA.likes, eg
- `Data` — used in: clone, DATA.likes, nb, eg
- `Cols` — used in: DATA.add, eg
- `clone` — used in: nb
- `SYM.like` — used in: Breakout (AI): Probability, Breakout (AI): The m-estimate, NUM.like, DATA.likes, Lecture 2 exercises
- `NUM.like` — used in: DATA.likes, Lecture 2 exercises
- `DATA.likes` — used in: Breakout (AI): The naive Bayes assumption, nb, Lecture 2 exercises
- `nb` — used in: eg, Main, Lecture 2 exercises, lib, Tables as both arrays and hashes, Multiple return values, --the, --sym, --num, --col, --cols, --data, --like, --likes, --nb
- `eg` — used in: Main, Tables as both arrays and hashes, Multiple return values, --data
- `Main` — used in: Lecture 2 exercises, the
- `isa` — used in: lib
- `the` — used in: lib, Tables as both arrays and hashes, Multiple return values, --the
- `--col` — used in: --cols
- `--like` — used in: --likes
