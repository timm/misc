...
\begin{frame}{Message}
  ...
  \begin{itemize}
    ...
    \item Previously:
      \begin{itemize}
        \item DRR: data reduction ratio: SE data tends to "flatten" far more than data from other sources.
        \item \yell{https://arxiv.org/abs/2503.21086}
        \item Above the "Andre threshold", astonishly simple methods work well
          \begin{itemize}
            \item For configuration;
            \item For project management;
            \item HYperparameter optimziation for predicting OSS project health.
            \item Banking, helath, power etc applications.
          \end{itemize}
      \end{itemize}
    \item Here:
  \begin{itemize}
...
\item For SE data, better HPO result can be achieved using \yell{AI
  designed for SE}.
  \end{itemize}
    \item FSE'26: BINGO effect: \yell{https://arxiv.org/pdf/2512.13524}. 
  \end{itemize}
\end{frame}
