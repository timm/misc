...
% 4. BACKGROUND: THE TECHNOLOGY
\begin{frame}{Class Hierarchy: Four Ways to Find a Cause}
\centering
\begin{tikzpicture}[
  box/.style={draw=LogicBlue, rounded corners, thick, fill=LiteRed, minimum width=2.5cm, minimum height=0.8cm},
...
This is a massive audit of how these tools behave on real-world SE evolution. [cite: 11]
\end{block}
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{The Menzies Rule:} If $J$ is low, your "Why Engine" is broken. [cite: 25]
\end{itemize}

\vspace{3mm}
\small
We measured Jaccard across versions, across tools, and across data subsets.
\end{frame}
...
% 9. FINDING 3: THE GENERATOR GAP (TOOLS)
\begin{frame}{Finding 3: The Tool War}
\textbf{Claim:} The tool you choose matters more than the data you have.

\vspace{3mm}
\begin{itemize}
    \item Median Jaccard between tools (PC vs GES): \textbf{0.25}.
    \item This means \textbf{75\% of edges} are contested by different algorithms.
    \item Which tool is "right"? Without a consensus, they might all be wrong.
\end{itemize}
\end{frame}

% 10. FINDING 4: PARAMETER SENSITIVITY
\begin{frame}{Finding 4: The Fragility of Alpha}
...
\begin{frame}{Finding 5: The 10\% Drop Test}
\textbf{Question:} If I hide 10\% of the data, does the graph survive?

\vspace{3mm}
\begin{itemize}
    \item \textbf{The Result:} Even small deletions of training data cause significant edge shifts.
    \item This exposes a lack of \textbf{repeatability} and \textbf{traceability}. [cite: 4]
\end{itemize}
\end{frame}
