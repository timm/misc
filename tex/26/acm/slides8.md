...
* Score $r$ relative to pre-treated $\mu$ to $d_{\min}$:


$W(r)=100 * \left(1 + \frac{D(r)-\mu}{\mu - d_{\min}}\right)$
...
* **Left:** $W \approx 55 + 0.4 * B * C$.
  Over 50 labels means 80+\% of optimum.
  More $B$ not useful.
* **Right:** 120+ datasets sorted by $D_{\min}$. Black =
