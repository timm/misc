...
\vspace{2mm}
$^{*}$RAG splits into: low-frequency Bayes (chunk matching)
...
* **Miller's Law:** Humans hold 7$\pm$2 chunks in working
...
* Score $r$ relative to pre-treated $\mu$ to $\min$:
\[
W(r)=100\times\!\left(1 +
\frac{D(r)-\mu}{\mu - \min}\right)
\]
...
* **Left:** $W \approx 55 + 0.4 \times B \times C$.
  ...
  More $B$ not useful.
* **Right:** 120+ datasets sorted by $\min$. Black =
