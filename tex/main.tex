...
\setbeamercolor{subtitle}{fg=mycolor}
\setbeamercolor{frametitle}{fg=mycolor, bg=white}
\setbeamercolor{titlelike}{parent=structure,bg=mucolor}

\setbeamercolor{title in head/foot}{bg=mycolor,fg=white} % If your theme uses a different color in header/footer
\setbeamercolor{block title}{bg=mycolor,fg=white} % If there are blocks in the title page

% Forcefully set the color
\setbeamercolor{footline}{fg=white, bg=mycolor}
\setbeamercolor{author in head/foot}{fg=white, bg=mycolor}
\setbeamercolor{title in head/foot}{fg=white, bg=mycolor}
\setbeamercolor{date in head/foot}{fg=white, bg=mycolor}
\setbeamercolor{section in head/foot}{fg=white, bg=mycolor}



\usetheme{Madrid} % or any other theme you are using
